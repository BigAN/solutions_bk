nohup python -u 9778_train_ftr.py --fileno avg_9778_rs_full --tra train_1_179903891_False_False.ftr --tst test_1_179903891_False_False.ftr --val val_1_179903891_False_False.ftr \
