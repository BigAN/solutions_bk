    ...
    with tick_tock("start add feature"):
        for n, af in enumerate(add_feas_files):
            ...
            if len(af) > 3:
                ...
                to_append = pd.read_feather("train_" + af + "_124903890_184903890_False_False.ftr")
                ...
                to_append = pd.read_feather("test_" + af + "_124903890_184903890_False_False.ftr")[be_added]
                check_join(test_df,to_append)
                test_df = test_df.join(to_append[be_added])
                gc.collect()
                to_append = pd.read_feather("val_" + af + "_124903890_184903890_False_False.ftr")[be_added]
