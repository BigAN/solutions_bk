...
if __name__ == '__main__':
    ...
    for n, feas in enumerate([
        ...
        # ["base", "area_agg", "poi_agg", "lasthour_poi_agg", "user_bin2", "poi_bin2", "poi_user_bin2",
        #  "high_level_arrive_guest"],
        # ["base", "area_agg", "poi_agg", "lasthour_poi_agg", "user_bin2", "poi_bin2", "poi_user_bin2",
        #  "high_level_arrive_shop"],
        # ["base", "area_agg", "poi_agg", "lasthour_poi_agg", "user_bin2", "poi_bin2", "poi_user_bin2",
        #  "high_level_arrive_guest", "high_level_arrive_shop"],
        # ["base", "area_agg", "poi_agg", "lasthour_poi_agg", "user_bin2", "poi_bin2", "poi_user_bin2",
        #     "user_bin3", "poi_bin3", "poi_user_bin3",
        #  "high_level_arrive_guest", "high_level_arrive_shop"],
        # ["base", "area_agg", "poi_agg", "lasthour_poi_agg", "user_bin2", "poi_bin2", "poi_user_bin2",
        #     "user_bin3", "poi_bin3", "poi_user_bin3",
        #  "high_level_arrive_guest", "high_level_arrive_shop"],
        # ["base", "area_agg", "poi_agg", "lasthour_poi_agg", "user_bin2", "poi_bin2", "poi_user_bin2",
        #     "user_bin3", "poi_bin3", "poi_user_bin3","user_bin4", "poi_bin4", "poi_user_bin4",
        #  "high_level_arrive_guest", "high_level_arrive_shop"],
        ["base", "area_agg", "poi_agg", "lasthour_poi_agg", "user_bin2", "poi_bin2", "poi_user_bin2",
            "user_bin3", "poi_bin3", "poi_user_bin3","user_bin4", "poi_bin4", "poi_user_bin4",
         "high_level_arrive_guest", "high_level_arrive_shop","cur_block_area_info","cur_block_poi_info"],
        ...
        params = {'num_leaves': 150, 'task': 'train', 'verbose': 1, 'learning_rate': 0.025, 'nthread': 8,
                  'min_data_in_leaf': 10, 'objective': 'regression', 'boosting_type': 'gbdt', 'metric': 'mae',
                  'feature_fraction': 1,"reg_alpha":20}
        ...
        for i in [0, 1, 2, 3, 4, 5, 6, 7]:
            ...
            tmp.append((mean_absolute_error(test_data[test_data.delivery_duration_bin == i][args.label],
                                            test_data[test_data.delivery_duration_bin == i]["delivery_duration_prd"]),
                        len(test_data[test_data.delivery_duration_bin == i]) * mean_absolute_error(
