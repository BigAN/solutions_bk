...
if __name__ == '__main__':
    ...
    #                                       prefix + prefix_sep.join(['poi_id']) + "_std_food_total_value": "std"},
    ...
    #                  "order_id": {prefix + prefix_sep.join(['poi_id']) + "_coor_count": "count",
    #                               }}
    ...
    #
    # cur_area_dict = {"_10min_working_rider_num": {"cur_10min_working_rider_sum": lambda x: x.iloc[-1]},
    #                  "_10min_notbusy_working_rider_num": {"cur_10min_notbusy_working_rider_sum": lambda x: x.iloc[-1]},
