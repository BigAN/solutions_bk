...
features = [u'order_tag_pref_30day', u'user_poi_click_decay', u'submit_tag_pref_15day', u'poi_reorder_rate',
            ...
            u'order_cnt_8hr', u'order_cnt_4hr', u'order_cnt_2hr', u'order_cnt_3hr', u'order_cnt_5hr']
...
if __name__ == '__main__':
    ...
    for f in features[3:]:
        ...
        params = {'num_leaves': 100, 'task': 'train', 'verbose': 1, 'learning_rate': 0.01, 'nthread': 8,
                  'min_data_in_leaf': 10, 'objective': 'binary', 'boosting_type': 'gbdt', 'metric': ['logloss', 'auc'],
                  'feature_fraction': 0.3, "bagging_fraction": 0.7, "bagging_freq": 5}
